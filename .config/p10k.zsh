# Generated by Powerlevel10k configuration wizard on 2019-11-09 at 18:13 CET.
...
# lightest, sparse, many icons, concise.
...
() {
  ...
  ##################################[ dir: current directory ]##################################
  # If set to true, will use absolute paths instead of home folder abbreviation ~
