# Generated by Powerlevel10k configuration wizard on 2022-07-14 at 13:34 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=green3
...
typeset -g POWERLEVEL9K_CONFIG_FILE=$XDG_CONFIG_HOME/p10k.zsh
